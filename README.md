...
## v5 changes
- Improved the hero orbit animation so all orbit layers visibly rotate.
- Added extra moving satellites to make the effect clearer.
- Replaced the orbit labels with more meaningful tags.
- Refreshed the GitHub avatar URL.
- Reduced the ALPINE image again and switched it to object-fit: contain so the whole image stays visible.
